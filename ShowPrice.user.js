...
(function () {
  ...
  const SITE_CONFIGS = [{
    ...
    },
    {
      ...
      darkPatterns: [{
          xpath: "//*[@data-component-name='pricing_price_base']//*",
          styles: {
            fontSize: "10px",
            fontWeight: "normal"
          }
        ...
        {
          xpath: "//*[@data-component-name='rich_text']",
          styles: {
            fontSize: "12px",
            fontWeight: "normal"
          }
    ...
    },
    {
      ...
      test: (url) => {
        try {
          // Method 1: new-style Shopping tab (udm=28 param)
          const u = new URL(url);
        ...
        // Method 2: (google.co.in/shopping, etc.)
        return url.includes("google.co") && url.includes("shop");
      },
      currency: "₹",
      separator: "&nbsp;",
      xpath: [
        ...
        "//a//div[contains(text(), '₹')]",
        "//span[contains(@aria-label, 'Current')]",
      ].join(" | "),
    },
    {
      name: "Myntra",
